    ...
    <div style={{ minHeight: '100vh', background: '#0A1628', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      ...
      <div style={{ width: '100%', maxWidth: '380px' }}>
        ...
        <div className="text-center mb-8" style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.8rem', color: 'white', letterSpacing: '0.05em', margin: 0 }}>
            VIDELA
          </h1>
          <p style={{ fontFamily: 'var(--font-condensed)', color: '#C9A84C', fontSize: '0.8rem', letterSpacing: '0.2em', margin: '4px 0 0' }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '28px' }}>
          ...
          {error && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px', padding: '12px', borderRadius: '8px', background: 'rgba(220,38,38,0.15)', border: '1px solid rgba(220,38,38,0.3)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <button onClick={handleLogin} disabled={loading} className="btn-gold w-full" style={{ marginTop: '4px', width: '100%' }}>
