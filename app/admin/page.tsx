  ...
  return (
    <div style={{ background: '#0A1628', minHeight: '100vh' }}>
      ...
      <main className="main-with-sidebar-tall">
        <div className="px-4 md:px-6 py-5 md:py-8" style={{ background: 'linear-gradient(135deg, #0a0a14, #141428, #0a0a14)', borderBottom: '1px solid rgba(255,255,255,0.1)', position: 'sticky', top: 0, zIndex: 10 }}>
