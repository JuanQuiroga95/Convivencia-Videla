"use strict";(()=>{var e={};e.id=729,e.ids=[729],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},14300:e=>{e.exports=require("buffer")},6113:e=>{e.exports=require("crypto")},82361:e=>{e.exports=require("events")},57147:e=>{e.exports=require("fs")},13685:e=>{e.exports=require("http")},95687:e=>{e.exports=require("https")},41808:e=>{e.exports=require("net")},22037:e=>{e.exports=require("os")},71017:e=>{e.exports=require("path")},12781:e=>{e.exports=require("stream")},24404:e=>{e.exports=require("tls")},57310:e=>{e.exports=require("url")},15206:e=>{e.exports=require("zlib")},31046:(e,r,a)=>{a.r(r),a.d(r,{originalPathname:()=>c,patchFetch:()=>d,requestAsyncStorage:()=>R,routeModule:()=>N,serverHooks:()=>u,staticGenerationAsyncStorage:()=>L});var t={};a.r(t),a.d(t,{GET:()=>T,PUT:()=>A});var i=a(49303),o=a(88716),s=a(60670),E=a(87070),n=a(9487);async function T(e){let r=await (0,n.AH)();if(!r)return E.NextResponse.json({ok:!1,error:"Base de datos no configurada."},{status:503});try{let{searchParams:a}=new URL(e.url),t=a.get("clave")||"pin_vir",i=await r`SELECT valor FROM configuracion WHERE clave = ${t}`;if(0===i.rows.length)return E.NextResponse.json({ok:!0,valor:null});return E.NextResponse.json({ok:!0,valor:i.rows[0].valor})}catch(e){return E.NextResponse.json({ok:!1,error:e.message},{status:500})}}async function A(e){let r=await (0,n.AH)();if(!r)return E.NextResponse.json({ok:!1,error:"Base de datos no configurada."},{status:503});try{let{clave:a,valor:t}=await e.json();if(!a||!t)return E.NextResponse.json({ok:!1,error:"Faltan datos."},{status:400});return await r`
      INSERT INTO configuracion (clave, valor) 
      VALUES (${a}, ${t}) 
      ON CONFLICT (clave) DO UPDATE SET valor = EXCLUDED.valor, updated_at = NOW()
    `,E.NextResponse.json({ok:!0,message:"Configuraci\xf3n actualizada"})}catch(e){return E.NextResponse.json({ok:!1,error:e.message},{status:500})}}let N=new i.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/config/route",pathname:"/api/config",filename:"route",bundlePath:"app/api/config/route"},resolvedPagePath:"C:\\Users\\juanp\\.gemini\\antigravity-ide\\scratch\\Convivencia-Videla\\app\\api\\config\\route.ts",nextConfigOutput:"",userland:t}),{requestAsyncStorage:R,staticGenerationAsyncStorage:L,serverHooks:u}=N,c="/api/config/route";function d(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:L})}},9487:(e,r,a)=>{async function t(){if(!process.env.POSTGRES_URL)return null;try{return(await a.e(462).then(a.bind(a,28462))).sql}catch{return null}}async function i(){if(!process.env.POSTGRES_URL)return null;try{return(await a.e(462).then(a.bind(a,28462))).db}catch{return null}}async function o(){let e=await t();if(!e)throw Error("POSTGRES_URL no configurada.");return await e`CREATE TABLE IF NOT EXISTS cursos (
    ...
    ON CONFLICT (usuario) DO NOTHING`,{ok:!0}}a.d(r,{$C:()=>s,AH:()=>t,VK:()=>i,kF:()=>o})}};var r=require("../../../webpack-runtime.js");r.C(e);var a=e=>r(r.s=e),t=r.X(0,[948,972],()=>a(31046));module.exports=t})();